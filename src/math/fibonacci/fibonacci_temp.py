...
############# Playing around with Fibonacce sequences ###############
...
# making a generator function out of the fibonacce sequence:
...
def fibonacci0(n):  # dangerous, not failsafe, will throw a RuntimeError after 6765 calls to slef
    if n == 0:
        return(0)
    if n == 1:
        return(1)
...
### _Recursion_, _memoization_ and _decorators_ illustrated with fibonacci sequences:
# Fortunately Python has decorator feature that gives you much better way of writing.
